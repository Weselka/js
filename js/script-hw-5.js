...
// console.log(car1.getBrand()); //повертає значення приватної властивості brand.
// car2.changeBrand('Honda'); //змінює значення приватної властивості brand на "Honda"
// console.log(car2);
